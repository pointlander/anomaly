...
The code for the complexity algorithm can be found [here](https://github.com/pointlander/anomaly/blob/master/complexity.go).
...
The code for the complexity with resampling algorithm can be found [here](https://github.com/pointlander/anomaly/blob/master/meta.go).
...
![Graph 15 Complexity distribution](graph_15_complexity_distribution.png?raw=true)

It can be seen that the complexity model learns over time:

![Graph 16 GRU vs time](graph_16_complexity.png?raw=true)
...
![Graph 17 Complexity with uncertainty vs time](graph_17_meta.png?raw=true)
...
- [x] Use [models for adaptive arithmetic coding](https://fgiesen.wordpress.com/2015/05/26/models-for-adaptive-arithmetic-coding/) for anomaly detection.
